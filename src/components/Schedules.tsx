...
export default function Schedules() {
  ...
  const ilmiahSchedule = [
    {
      day: "Hari 1 - Sabtu, 14 November 2026",
      events: [
        {
          time: "07:30 - 08:30",
    ...
    {
      day: "Hari 2 - Minggu, 15 November 2026",
      events: [
        {
          time: "08:00 - 10:00",
  ...
  // Pesta Rakyat Schedule Data (Stadion Pekansari)
  const pestaSchedule = [
    {
      day: "Hari 2 - Minggu, 15 November 2026 (Stadion Pekansari)",
      events: [
        {
          time: "05:30 - 06:00",
          title: "Kumpul Peserta & Distribusi Atribut/Konsumsi Pagi",
          location: "Area Parkir Barat Stadion Pekansari",
        ...
        },
        {
          ...
          location: "Rute Lingkar Stadion Pekansari (1.5 KM)",
        ...
        },
        {
          ...
          location: "Tenda Medis Utama Pekansari",
        ...
        },
        {
          ...
          location: "Panggung Utama Pekansari",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <div className="inline-flex p-1 bg-[#F8FAFC] rounded-full shadow-inner border border-slate-100">
            ...
            >
              Pesta Rakyat (Stadion Pekansari)
            </button>
          </div>
        </div>
