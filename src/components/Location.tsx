...
export default function Location() {
  const [activeVenue, setActiveVenue] = useState<"novotel" | "pekansari">("novotel");
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="inline-flex p-1 bg-white rounded-full shadow border border-slate-100">
            ...
            <button
              onClick={() => setActiveVenue("pekansari")}
              className={`px-5 py-2.5 rounded-full text-xs sm:text-sm font-extrabold transition-all duration-300 cursor-pointer ${
                activeVenue === "pekansari"
                  ? "bg-[#1E3A8A] text-white shadow"
                  : "text-slate-600 hover:text-[#1E3A8A]"
              }`}
            >
              Stadion Pekansari (Pesta Rakyat)
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-6 space-y-6">
            {activeVenue === "novotel" ? (
              ...
              <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-md border border-slate-100 space-y-6">
                ...
                <div>
                  <h3 className="text-xl sm:text-2xl font-black text-slate-800">Stadion Pakansari (Pekansari Cibinong)</h3>
                ...
                <div className="space-y-3.5 text-xs sm:text-sm text-slate-600">
                  <p className="flex items-start gap-2">
                    <MapPin className="h-5 w-5 text-[#0D9488] shrink-0 mt-0.5" />
                    <span>Jalan Stadion Pakansari No.1, Pakansari, Kec. Cibinong, Kabupaten Bogor, Jawa Barat 16915</span>
                  </p>
                  <p className="flex items-start gap-2">
                    <Navigation className="h-5 w-5 text-[#0D9488] shrink-0 mt-0.5" />
                ...
                <div className="p-4 bg-emerald-50 rounded-2xl border border-emerald-100 space-y-2">
                  <h4 className="text-xs font-bold text-emerald-800 flex items-center gap-1">
                    ...
                    Fasilitas di Stadion Pekansari:
                  </h4>
          ...
          <div className="lg:col-span-6 bg-white rounded-3xl p-4 shadow-md border border-slate-100 h-96 sm:h-[450px] flex flex-col overflow-hidden">
            <div className="p-3 bg-slate-50 border-b border-slate-100 flex justify-between items-center shrink-0">
              ...
              <a
                href={activeVenue === "novotel" ? "https://maps.google.com/?q=Novotel+Bogor" : "https://maps.google.com/?q=Stadion+Pakansari"}
                target="_blank"
                rel="noreferrer"
            ...
            {/* Simulated Satellite View Image using Unsplash background with map pins pin overlays */}
            <div className="relative flex-1 bg-slate-100 overflow-hidden">
              <img
                src={
                  activeVenue === "novotel"
                    ? "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&q=80&w=600" // Resort layout resembling Novotel resort
                    : "https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&q=80&w=600" // Stadium field resembling Pekansari
                }
              ...
              <div className="absolute inset-0 bg-slate-900/10 flex items-center justify-center">
                <div className="bg-white/95 backdrop-blur-md rounded-2xl p-4 max-w-xs shadow-2xl text-center border border-[#0D9488]/40 animate-pulse">
                  ...
                  <strong className="text-slate-800 text-xs block leading-tight">
                    {activeVenue === "novotel" ? "Novotel Bogor Resort" : "Stadion Pekansari Cibinong"}
                  </strong>
                  <span className="text-[9px] text-[#1E3A8A] block font-semibold mt-1">14 - 15 November 2026</span>
                </div>
              </div>
