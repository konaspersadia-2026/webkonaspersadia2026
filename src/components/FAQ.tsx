  ...
  const faqs = [
    {
      ...
      a: "Acara ini terbuka lebar untuk dua kelompok audiens: (1) Tenaga medis profesional seperti dokter spesialis endokrin/lainnya, dokter umum, perawat, ahli gizi, dan mahasiswa kedokteran untuk mengikuti Sesi Ilmiah di Novotel Bogor. (2) Penyandang diabetes (diabetesi) beserta keluarga mereka, dan masyarakat umum untuk mengikuti rangkaian Pesta Rakyat & skrining kesehatan gratis di Stadion Pekansari Cibinong."
    },
    {
    ...
    {
      q: "Apakah pendaftaran Pesta Rakyat di Stadion Pekansari wajib membayar?",
